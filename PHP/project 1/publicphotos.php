...
<?php
$perpage = 20;
$msgcount = mysql_query("SELECT COUNT(*) FROM publicphotos");
$pages = ceil(mysql_result($msgcount, 0) / $perpage);
$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
$start = ($page - 1) * $perpage;
	$photores = mysql_query("SELECT * FROM publicphotos ORDER BY Date DESC LIMIT $start, $perpage");
	...
	echo "</div>";
	?>
	</div><input type='button' onClick=parent.location='uploadpublicphotos.php' value='Upload Public Photos'></input><br />
</div>

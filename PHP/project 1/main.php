...
<div id="holder">
	<ul>
		<li><a id="onlink" href="main.php">Private Board</a></li>
		<li><a href="publicpost.php">Public Board</a></li>
		<li><a href="friendboard.php">Friends Board</a></li>
	</ul>		
	</div>
</div>
<div class="messageboard"><form action="message.php" method="POST"><p>Post Message:</p><textarea name="msgpost"></textarea><br /><input type="submit" name="post" value='Post' id="postbutton"></input></form><br /></div><br />
<?php 
$perpage = 20;

...
<?php
		$fprores = mysql_query("SELECT * FROM userdetails WHERE Username='$frndname'");
	...
	$fproresult = mysql_query("SELECT * FROM personaldetails WHERE Username='$frndname'");
 	while($fpprow = mysql_fetch_array($fproresult))
	{
		...
		$abtme = $fpprow['About'];	
$fimgresult = mysql_query("SELECT * FROM imagedetails WHERE Username='$frndname'");

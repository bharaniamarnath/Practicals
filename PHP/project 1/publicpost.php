...
<div id="holder">
	<ul>
		...
		<li><a id="onlink" href="publicpost.php">Public Board</a></li>
...
<?php 
$perpage = 20;
$msgcount = mysql_query("SELECT COUNT(*) FROM bulletin");
$pages = ceil(mysql_result($msgcount, 0) / $perpage);
$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
$start = ($page - 1) * $perpage;
$msgresult = mysql_query("SELECT * FROM bulletin ORDER BY Time DESC LIMIT $start, $perpage");
	...
	echo "</h4>";
	echo $postm;
	echo "<form action='deletebulletin.php' method='POST'>";

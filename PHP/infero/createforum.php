...
<table>
<tr><td>Forum Topic: </td><td><input type="text" name="fotitle" id="fotitle" /></td></tr>
<tr><td>Content: </td><td><textarea size="1024" rows="6" cols="50" name="focontent" id="focontent" onkeyup="countChar(this)"></textarea></td></tr>
<tr><td></td><td><input type="submit" name="upload" id="upload" value="Create Forum"></input><div id="charNum"></div></td>
</table>
</form>
</div>
<div id="userpanel">

...
<div id="maincontent">
<div id="sitepath">
<a href="home.php">Infero</a><img src="images/patharrow.png" /><a href="downloads.php">Downloads</a>
</div>
<div id="welcome">
<h5>Welcome to Infero Blog</h5>
<p>Hello, and welcome to Infero Downloads section. Check out the interesting articles, forums, discussions, downloads and many more useful informations.</p>
<input type="button" id="close" value="close"></input>
</div>
<div id="newarticles">
<h5>Downloads</h5>
<?php 
$aresult = mysql_query("SELECT * FROM downloads ORDER BY Date DESC");
while($arow = mysql_fetch_array($aresult)){
$ftitle = $arow['Title'];
$fcontent = $arow['Content'];
$flink = $arow['Link'];
$fsize = $arow['Size'];
$fuploader = $arow['Uploader'];
$fdate = $arow['Date'];
	echo "<div id='articlebox'>";
	echo "<h4>";
	echo $ftitle;
	echo "</h4>";
	echo "<div id='adate'>Posted on: $fdate</div>";
	echo $fcontent;
	echo "<br />";
	echo "<div id='fsize'>File size: $fsize</div>";
	echo "<a id='downloadbutton' href='$flink'>Download File</a>";
	echo "<div id='auploader'>Posted by: $fuploader</div>";
	echo "</div>";
}
?>
</div>

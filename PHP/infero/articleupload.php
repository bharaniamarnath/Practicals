...
<table>
<tr><td>Article Title: </td><td><input type="text" name="atitle" id="atitle" /></td></tr>
<tr><td>Content: </td><td><textarea size="1024" rows="6" cols="50" name="acontent" id="acontent" onkeyup="countChar(this)"></textarea></td></tr>
<tr><td></td><td><input type="submit" name="upload" id="upload" value="Upload Article"></input><div id="charNum"></div></td>
</table>
</form>
</div>
<div id="userpanel">
